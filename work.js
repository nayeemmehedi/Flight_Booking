...
function make_voucher() {
  ...
  document.getElementById("total_Price").innerText = "$" + totalPrice_value


  let vat_value = (totalPrice_value * 10) / 100

  document.getElementById("vat_id_num").innerText = "$" + vat_value

  let last_total_value = totalPrice_value + vat_value


  document.getElementById("last_Total").innerText = "$" + last_total_value
